...
replace predict_bet=0 if inrange(predict_bet,-1,0)
...
graph twoway (rarea active_rate_adjusted_ll active_rate_adjusted_ul time, color(gs10)) ///
	...
	xtitle("Date") ///
	xlabel(1 "March" 60 "May" 121 "July" 183 "September" 244 "November" 305 "January" 363 "March" 424 "April" `today' "Today", labc(black)) ///
	yscale(range(0 0.25)) ///
	...
	yline(0 .02 .04 .06 .08  .10 .12 .14 .16 .18 .20 .22 .24 , lp(solid) lc(gs6)) ///
	scheme(blue) ///
	xlabel(, angle(45)) ///
